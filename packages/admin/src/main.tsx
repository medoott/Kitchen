...
import TableBoard from './pages/TableBoard.js';
  ...
  return (
    <AdminLayout onLogout={logout}>
      <Routes>
        ...
        <Route path="/tables/board" element={<RequireRole roles={['SUPER_ADMIN', 'MANAGER', 'STAFF', 'DEVELOPER']}><TableBoard /></RequireRole>} />
        <Route path="/tables/board/:locationId" element={<RequireRole roles={['SUPER_ADMIN', 'MANAGER', 'STAFF', 'DEVELOPER']}><TableBoard /></RequireRole>} />
        ...
        <Route path="/design" element={<RequireRole roles={['SUPER_ADMIN', 'MANAGER', 'DEVELOPER']}><Navigate to="/design/landing" replace /></RequireRole>} />
        <Route path="/design/landing" element={<RequireRole roles={['SUPER_ADMIN', 'MANAGER', 'DEVELOPER']}><DesignLanding /></RequireRole>} />
        <Route path="/design/branding" element={<RequireRole roles={['DEVELOPER']}><DesignBranding /></RequireRole>} />
        <Route path="/design/theme" element={<RequireRole roles={['DEVELOPER']}><DesignTheme /></RequireRole>} />
        <Route path="/design/templates" element={<RequireRole roles={['SUPER_ADMIN', 'MANAGER', 'DEVELOPER']}><DesignTemplates /></RequireRole>} />
        <Route path="/design/gallery" element={<RequireRole roles={['SUPER_ADMIN', 'MANAGER', 'DEVELOPER']}><DesignGallery /></RequireRole>} />
        <Route path="/design/media" element={<RequireRole roles={['SUPER_ADMIN', 'MANAGER', 'DEVELOPER']}><DesignMedia /></RequireRole>} />
        ...
        {/* Developer — SUPER_ADMIN for audit log, DEVELOPER for metrics */}
        <Route path="/developer" element={<RequireRole roles={['SUPER_ADMIN']}><Navigate to="/developer/audit-log" replace /></RequireRole>} />
        <Route path="/developer/audit-log" element={<RequireRole roles={['SUPER_ADMIN']}><AuditLog /></RequireRole>} />
        <Route path="/developer/metrics" element={<RequireRole roles={['DEVELOPER']}><DeveloperMetrics /></RequireRole>} />

        {/* SUPER_ADMIN only */}
        <Route path="/staff" element={<RequireRole roles={['SUPER_ADMIN']}><StaffList /></RequireRole>} />
        <Route path="/staff/new" element={<RequireRole roles={['SUPER_ADMIN', 'MANAGER']}><StaffInvite /></RequireRole>} />
